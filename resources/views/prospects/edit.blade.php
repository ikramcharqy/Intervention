                    ...
                    <form action="{{ route('prospects.update', $prospect) }}" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    @foreach(\App\Models\Prospect::TYPES_PROSPECT as $tp)
                                        <label class="inline-flex items-center gap-2 text-sm text-gray-700">
                                            <input type="radio" name="type_prospect" value="{{ $tp }}" onchange="toggleNomLabel()"
                                                   {{ old('type_prospect', $prospect->type_prospect) == $tp ? 'checked' : '' }}
                            ...
                            <div>
                                ...
                                <input type="text" name="telephone" value="{{ old('telephone', $prospect->telephone) }}" placeholder="0612345678" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
