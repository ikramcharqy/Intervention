<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Nouveau Formulaire</h2>
    </x-slot>
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900 dark:text-gray-100">
                ...
                <form method="POST" action="{{ route('formulaires.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-xs text-gray-500 mt-1">Seuls les types sans formulaire sont affichés.</p>
                    </div>
                    ...
                    <div class="flex justify-end gap-2">
                        ...
                        <button type="submit" class="bg-blue-500 text-white px-4 py-2 rounded-md hover:bg-blue-600">Créer et continuer</button>
                    </div>
                </form>
            </div>
        </div>
