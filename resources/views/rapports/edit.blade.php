<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            Modifier le Rapport de l'Intervention : {{ $rapport->intervention->code_intervention ?? 'N/A' }}
        </h2>
    </x-slot>
    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6 text-gray-900 dark:text-gray-100">
                <form method="POST" action="{{ route('rapports.update', $rapport) }}" class="space-y-4">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="datetime-local" name="date_debut" id="date_debut" required
                                value="{{ old('date_debut', $rapport->date_debut ? $rapport->date_debut->format('Y-m-d\TH:i') : '') }}"
                        ...
                        <div>
                            ...
                            <input type="datetime-local" name="date_fin" id="date_fin" required
                                value="{{ old('date_fin', $rapport->date_fin ? $rapport->date_fin->format('Y-m-d\TH:i') : '') }}"
                                class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">
                    ...
                    <div>
                        ...
                        <textarea name="commentaire" id="commentaire" rows="5"
                            class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">{{ old('commentaire', $rapport->commentaire) }}</textarea>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" name="signature_technicien" id="signature_technicien"
                                value="{{ old('signature_technicien', $rapport->signature_technicien) }}"
                                class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">
                        ...
                        <div>
                            ...
                            <input type="text" name="signature_client" id="signature_client"
                                value="{{ old('signature_client', $rapport->signature_client) }}"
                                class="w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300">
                    ...
                    <div class="flex gap-3">
                        ...
                        <a href="{{ route('rapports.show', $rapport) }}" class="bg-gray-500 text-white px-4 py-2 rounded-md hover:bg-gray-600">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
